...
class ODRegionRepresentationDataset(AbstractDataset):
    def __init__(self,config):
        ...
        self.od_mx_path = './libcity/cache/dataset_cache/{}/od_mx.npy'.format(self.dataset)
    ...
    def _load_geo(self):
        ...
        self.region_geometry = gpd.GeoSeries.from_wkt(geofile[geofile['traffic_type'] == 'region']['geometry'])
    ...
    def _load_od(self):
        ...
        self._logger.info("totoal_flow = {}".format(total_flow))
