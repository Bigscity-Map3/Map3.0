...
class HRNR(AbstractRoadRepresentationModel):
    ...
    def calculate_loss1(self,node_embedding):
        dot_product=node_embedding.T*node_embedding
        adj_hat=F.sigmoid(dot_product)
        return F.cross_entropy(self.adj,adj_hat)

    def calculate_loss2(self,node_embedding):
        dot_product=node_embedding.T*node_embedding
        adj_hat=F.sigmoid(dot_product)
        return F.cross_entropy(self.adj,adj_hat)
