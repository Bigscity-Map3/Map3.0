import pandas as pd
import numpy as np
from libcity.model.poi_representation.utils import get_delta, split_sampleSeq2sessions, splitSeq_basedonSessions, get_relativeTime
import copy
class cacsr_sample(object):
