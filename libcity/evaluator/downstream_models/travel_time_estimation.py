...
class TravelTimeEstimationModel(AbstractModel):
    ...
    def run(self, embedding_vector, label, embed_model=None,**kwargs):
        ...
        train_data_X ,train_data_lens,train_data_y = x_arr[:train_size],lens_arr[:train_size],y_arr[:train_size]
        test_data_X , test_data_lens, test_data_y = x_arr[train_size:], lens_arr[train_size:], y_arr[train_size:]
        train_dataset = TimeEstimationDataset(train_data_X,train_data_lens,train_data_y)
        test_dataset = TimeEstimationDataset(test_data_X,test_data_lens,test_data_y)
