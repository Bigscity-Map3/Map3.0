...
from veccity.upstream.point.utils import next_batch, init_seed
from veccity.data.dataset.dataset_subclass import TeaserData,SkipGramData,CacsrData

from veccity.upstream.point.tale import TaleData
from veccity.upstream.point.poi2vec import P2VData
# from veccity.upstream.point.teaser import TeaserData
# from veccity.upstream.point.w2v import SkipGramData
# from veccity.upstream.point.cacsr import CacsrData
...
class CTLEDataLoader(PointDataloader):
...
class HierDataLoader(PointDataloader):
...
class TaleDataLoader(PointDataloader):
...
class TeaserDataLoader(PointDataloader):
...
class SkipGramDataLoader(PointDataloader):
...
class CacsrDataLoader(PointDataloader):
    def __init__(self, config, data_feature, data):
        super().__init__(config, data_feature, data)
