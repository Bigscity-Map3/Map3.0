...
class LineExecutor(AbstractExecutor):
    ...
    def train(self, train_dataloader, eval_dataloader=None):
        ...
        node_embedding = self.model.get_entity_embedding()
